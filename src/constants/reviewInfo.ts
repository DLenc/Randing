...
const Review: reviewProps[] = [
  ...
  },
  {
    ...
    content:
      'D-Silent Floor는 현장 중량 테스트에서 국내 최초 2급을 받았다고 하는데, 실험실에서 인증 받은 바닥구조와 현장에서 측정한 바닥구조 간에 차이가 많이 난다고 합니다. <b>그렇기에 DL이앤씨에서 받은 국내 최초 중량 2급이 더 의미있다고 생각 했습니다.</b> 또, D-Silence Service는 아랫층 뿐만 아니라 윗층도 층간소음으로 고통을 겪는다는 것에 초점을 맞춘 기획이라고 합니다. 이런 DL이앤씨의 기술들은 입구에서 마주한 <b>‘진심이 짓는다’는 말의 뜻을 느낄 수 있게 해주는 기술들이었습니다.</b>',
