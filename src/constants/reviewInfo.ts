...
const Review: reviewProps[] = [
  ...
  },
  {
    ...
    content:
      '연구소에서 임팩트 볼과 태핑머신을 이용해 기존 바닥 구조와 D-Silent Floor의 소음 정도를 비교했을 때, <b>확연한 차이를 느낄 수 있었습니다.</b> D-Silence Service는 실시간으로 소음 발생 빈도를 확인할 수 있고, 데이터를 통해 생활 습관 개선이 가능하며, 지진 알람 시스템으로도 활용이 가능하다는 점이 획기적이란 생각이 들었습니다. 또한, 층간 소음 분쟁 발생을 사전에 예방할 수 있다는 점도 놀라웠습니다.',
